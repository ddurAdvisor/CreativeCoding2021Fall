...
* @Date:   2020-12-06 17:10:46
* @brief
* @Last Modified by:   bit2atommac2019
* @Last Modified time: 2021-10-18 14:26:52
* @detail
*/
class Ball {
  PVector loc;
 ...
 * @Author   bit2atom
 * @DateTime 2021-10-18T14:26:35+0800
 ...
 * [update description]
 * @Author   bit2atom
 * @DateTime 2021-10-18T14:26:40+0800
 * @return   {[type]}                 [description]
 */
  void update() {
    acc.add(gravity);
 ...
 * [edge description]
 * @Author   bit2atom
 * @DateTime 2021-10-18T14:26:45+0800
 * @return   {[type]}                 [description]
 */
  void edge() {
    if (loc.x>width-r) {
 ...
 * [show description]
 * @Author   bit2atom
 * @DateTime 2021-10-18T14:26:50+0800
 * @return   {[type]}                 [description]
 */
  void show() {
    stroke(255);
